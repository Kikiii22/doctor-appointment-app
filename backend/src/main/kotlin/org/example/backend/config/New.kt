        ...
        http
            ...
            .authorizeHttpRequests { authz ->
                authz
                    ...
                    .requestMatchers("/api/patients/*/appointments","/api/appointments/book","/api/appointments/cancel","/api/doctors","/api/doctors/*").hasAnyRole("PATIENT", "ADMIN","DOCTOR").anyRequest().authenticated()
